...
<img src="/assets/images/installer.png" alt="java" width="100%" itemprop="image">
...
<img src="/assets/images/java_home.png" alt="java" width="80%" itemprop="image">

- [새로 만들기]를 클릭하여 변수 이름을 [JAVA_HOME]로 하고 변수 값을 설치 경로로 넣어준다.<br/>

<img src="/assets/images/classpath.png" alt="java" width="80%" itemprop="image">


- 다시 새로 만들기를 클릭 후 변수 이름은 [CLASSPATH]로 하고 변수 값은 [%JAVA_HOME%\lib]를 넣어준다.<br/>


<img src="/assets/images/path.png" alt="java" width="70%" itemprop="image">
...
<img src="/assets/images/cmd.png" alt="java" width="100%" itemprop="image">
